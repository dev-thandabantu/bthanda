...
export const cvSkills: CvSkill[] = [
  ...
  { label: "Frameworks & Libraries", value: "FastAPI, Vercel AI SDK, ASP.NET Core, Next.js, React, Flutter, Django, Entity Framework Core, LangChain, LlamaParse, PyMuPDF" },
  { label: "Databases & Storage", value: "PostgreSQL, SQL Server, Supabase, Firebase (Firestore + Auth + Storage), Pinecone, Azure Blob Storage, Cloudflare R2" },
